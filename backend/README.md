...
## Project Structure
    ...
    ├── the_profect_soccer_35202  # Django project configurations
...
1. Clone this repo and `cd the_profect_soccer_35202`
...
2. Clone this repo and `cd the_profect_soccer_35202`
